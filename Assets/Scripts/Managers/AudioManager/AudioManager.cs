...
public class AudioManager : MonoBehaviour
{
    ...
    public void SFXDelayAndFade(AudioSource source, bool play, float targetVolume, float delay = 0, float fadeDuratuin = 1)
    {
        StartCoroutine(SFXDelayAndFadeCo(source, play, targetVolume, delay, fadeDuratuin));
    }
