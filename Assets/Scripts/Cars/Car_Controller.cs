...
public class Car_Controller : MonoBehaviour
{
    ...
    private bool canEmmitTrails = true;
    ...
    private void ApplyTailsOnTheGround()
    {
        if(canEmmitTrails == false)
        {
            return;
        }
    ...
    // private void CameraTransform(Transform cam, float distance)
    // {
    //     Vector3 offset =
    //         -transform.forward * distance +   // move back
    //         Vector3.up * 12f;                   // move up (adjust this)
    ...
    // {
    //     ActivateCar(true);
    //     CameraTransform(cameraTransform, 15);
    // }
}
